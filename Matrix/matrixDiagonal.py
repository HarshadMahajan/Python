...
def leftDiagonalOrder(matrix):
   for slice in range(2 * ROW - 1, 0, -1):
       z = 0 if slice < ROW else slice - ROW +1
       for j in range(slice-z,z,-1):
